...
<body>
    ...
    <section class="menu-header">
        <div class="container">
            <h1>Bento Cake</h1>
            <p>Kue mini lucu dalam kotak bento yang menggemaskan</p>
        </div>
    </section>
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <div class="product-image">
                        @if($product['name'] == 'Bento Cupcake')
                            <img src="/images/BentoCupcake.jpeg" alt="Bento Cupcake" class="product-icon-img">
                        @elseif($product['name'] == 'Bento Cake')
                            <img src="/images/BentoCake.jpeg" alt="Bento Cake" class="product-icon-img">
                        @else
                            <img src="/images/icon-bento-cake.png" alt="Bento Cake" class="product-icon-img">
                        @endif
                    </div>
