...
<body>
    ...
    <section class="menu-header">
        <div class="container">
            ...
            <p>Kue khas Belanda dengan cita rasa yang autentik</p>
        </div>
    </section>
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <div class="product-image">
                        @if($product['name'] == 'Lekker Holland')
                            <img src="/images/LekkerHolland.jpeg" alt="Lekker Holland" class="product-icon-img">
                        @else
                            <img src="/images/icon-lekker-holland.png" alt="Lekker Holland" class="product-icon-img">
                        @endif
                    </div>
