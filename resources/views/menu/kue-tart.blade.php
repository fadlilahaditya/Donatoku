...
<head>
    ...
    <title>Kue Tart - Donatoku De Patisserie</title>
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-menu">
                ...
                <a href="{{ route('menu.kue-tart') }}" class="nav-link active">Kue Tart</a>
    ...
    <section class="menu-header">
        <div class="container">
            <h1>Kue Tart</h1>
            <p>Koleksi kue tart dengan berbagai ukuran dan dekorasi menarik</p>
        </div>
    </section>
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <div class="product-image">
                        @if($product['name'] == 'Tart Anak Laki-laki')
                            <img src="/images/TartAnakLakiLaki.jpeg" alt="Tart Anak Laki-laki" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Hias Leleh Coklat')
                            <img src="/images/TartHiasLelehCoklat.jpeg" alt="Tart Hias Leleh Coklat" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Kupu Kupu')
                            <img src="/images/TartKupuKupu.jpeg" alt="Tart Kupu Kupu" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Merah Putih')
                            <img src="/images/TartMerahPutih.jpeg" alt="Tart Merah Putih" class="product-icon-img">
                        @elseif($product['name'] == 'Tart 2 Boneka')
                            <img src="/images/Tart2Boneka.jpeg" alt="Tart 2 Boneka" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Buket')
                            <img src="/images/TartBuket.jpeg" alt="Tart Buket" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Serba Coklat')
                            <img src="/images/TartSerbaCoklat.jpeg" alt="Tart Serba Coklat" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Puding')
                            <img src="/images/TartPuding.jpeg" alt="Tart Puding" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Tingkat')
                            <img src="/images/TartTingkat.jpeg" alt="Tart Tingkat" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Coquette')
                            <img src="/images/TartCoquette.jpeg" alt="Tart Coquette" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Karakter')
                            <img src="/images/TartKarakter.jpeg" alt="Tart Karakter" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Topper')
                            <img src="/images/TartTopper.jpeg" alt="Tart Topper" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Anak Perempuan')
                            <img src="/images/TartAnakPerempuan.jpeg" alt="Tart Anak Perempuan" class="product-icon-img">
                        @elseif($product['name'] == 'Tart Hias Topper')
                            <img src="/images/TartHiasTopper.jpeg" alt="Tart Hias Topper" class="product-icon-img">
                        @else
                            <img src="/images/tart.png" alt="Kue Tart" class="product-icon-img">
                        @endif
                    </div>
                        ...
                        @if(isset($product['sizes']))
                            <div class="product-sizes">
                                ...
                                <div class="size-option" data-size="{{ $size['size'] }}" data-price="{{ $size['price'] }}">
                                    <span class="size">{{ $size['size'] }}cm</span>
